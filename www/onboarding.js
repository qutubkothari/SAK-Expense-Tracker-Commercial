...
const tutorialSteps = [
  {
    ...
    content: 'Here you can see your monthly expenses, transaction count, and AI insights at a glance.',
    position: 'bottom'
  },
  {
    target: '#amount',
    title: '💰 Add Expenses',
    content: 'Enter the amount, select category, and click Add. It\'s that simple!',
    position: 'bottom'
  },
  {
    target: '#voiceBtn',
    title: '🎤 Voice Input',
    content: 'Click Voice, wait for "Listening...", then say: "500 rupees for groceries at Carrefour"',
    position: 'top'
  },
  {
    target: '#smsBtn',
  ...
  },
  {
    ...
    content: 'Take a photo of receipts and we\'ll extract the amount, merchant, and date automatically!',
    position: 'top'
  },
  {
    target: '#manageBudgetsBtn',
    title: '📊 Set Budgets',
    content: 'Create category budgets and get alerts when you\'re approaching your limits.',
    position: 'bottom'
  },
  {
    target: '#themeToggle',
  ...
  },
  {
    ...
    content: 'Filter by date, category, location, or business to analyze your spending patterns.',
    position: 'top'
  }
];
